 ...
 */
final class Version20200330202707 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE asset_types ADD img_url VARCHAR(255) DEFAULT NULL, CHANGE asset_categories_id asset_categories_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admin_sent_mails CHANGE user_id user_id INT DEFAULT NULL, CHANGE admin_mail_id admin_mail_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE asset_images CHANGE assets_id assets_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE asset_types DROP img_url, CHANGE asset_categories_id asset_categories_id INT DEFAULT NULL');
