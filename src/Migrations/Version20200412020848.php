 ...
 */
final class Version20200412020848 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE loging_levels (id INT AUTO_INCREMENT NOT NULL, value_name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE variables (id INT AUTO_INCREMENT NOT NULL, value_id INT NOT NULL, variable_name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_88CB7D11F920BBA2 (value_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE variables ADD CONSTRAINT FK_88CB7D11F920BBA2 FOREIGN KEY (value_id) REFERENCES loging_levels (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE variables DROP FOREIGN KEY FK_88CB7D11F920BBA2');
        $this->addSql('DROP TABLE loging_levels');
