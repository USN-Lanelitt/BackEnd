 ...
 */
final class Version20200415213628 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rating_loans ADD comment_from_loaner LONGTEXT DEFAULT NULL, ADD comment_from_borrower LONGTEXT DEFAULT NULL, DROP comment_loaner, DROP comment_borrower, CHANGE loans_id loans_id INT DEFAULT NULL, CHANGE rating_of_loaner rating_of_loaner INT DEFAULT NULL, CHANGE rating_of_borrower rating_of_borrower INT DEFAULT NULL, CHANGE rating_asset rating_asset NUMERIC(10, 0) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE loggin_logs CHANGE users_id users_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE rating_loans ADD comment_loaner LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD comment_borrower LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP comment_from_loaner, DROP comment_from_borrower, CHANGE loans_id loans_id INT DEFAULT NULL, CHANGE rating_of_loaner rating_of_loaner INT DEFAULT NULL, CHANGE rating_of_borrower rating_of_borrower INT DEFAULT NULL, CHANGE rating_asset rating_asset INT DEFAULT NULL');
        $this->addSql('ALTER TABLE unwanted_behavior_reports CHANGE reporter_id reporter_id INT DEFAULT NULL, CHANGE reported_id reported_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user_connections CHANGE user1_id user1_id INT DEFAULT NULL, CHANGE user2_id user2_id INT DEFAULT NULL, CHANGE request_status_id request_status_id INT DEFAULT NULL, CHANGE timestamp timestamp DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE user_has_user_rights CHANGE user_id user_id INT DEFAULT NULL, CHANGE user_rights_id user_rights_id INT DEFAULT NULL');
