 ...
 */
final class Version20200428190547 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE eiendel (id INT AUTO_INCREMENT NOT NULL, navn VARCHAR(250) NOT NULL, beskrivelse LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kattepuser (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE rating_loans CHANGE loans_id loans_id INT DEFAULT NULL, CHANGE rating_of_loaner rating_of_loaner INT DEFAULT NULL, CHANGE rating_of_borrower rating_of_borrower INT DEFAULT NULL, CHANGE rating_asset rating_asset NUMERIC(2, 1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE eiendel');
        $this->addSql('DROP TABLE kattepuser');
        $this->addSql('ALTER TABLE admin_sent_mails CHANGE user_id user_id INT DEFAULT NULL, CHANGE admin_mail_id admin_mail_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE asset_images CHANGE assets_id assets_id INT DEFAULT NULL');
