 ...
 */
final class Version20200320171810 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_connections ADD request_status_id INT DEFAULT NULL, DROP request_status, CHANGE user1_id user1_id INT DEFAULT NULL, CHANGE user2_id user2_id INT DEFAULT NULL, CHANGE timestamp timestamp DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE user_connections ADD CONSTRAINT FK_16ED35802006F11A FOREIGN KEY (request_status_id) REFERENCES request_status (id)');
        $this->addSql('CREATE INDEX IDX_16ED35802006F11A ON user_connections (request_status_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rating_loans CHANGE loans_id loans_id INT DEFAULT NULL, CHANGE rating_of_loaner rating_of_loaner INT DEFAULT NULL, CHANGE rating_of_borrower rating_of_borrower INT DEFAULT NULL, CHANGE rating_asset rating_asset INT DEFAULT NULL');
        $this->addSql('ALTER TABLE unwanted_behavior_reports CHANGE reporter_id reporter_id INT DEFAULT NULL, CHANGE reported_id reported_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user_connections DROP FOREIGN KEY FK_16ED35802006F11A');
        $this->addSql('DROP INDEX IDX_16ED35802006F11A ON user_connections');
        $this->addSql('ALTER TABLE user_connections ADD request_status TINYINT(1) NOT NULL, DROP request_status_id, CHANGE user1_id user1_id INT DEFAULT NULL, CHANGE user2_id user2_id INT DEFAULT NULL, CHANGE timestamp timestamp DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE user_has_user_rights CHANGE user_id user_id INT DEFAULT NULL, CHANGE user_rights_id user_rights_id INT DEFAULT NULL');
